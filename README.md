```text
Osobní web — návod k použití
----------------------------

Jak použít:
1. Vytvoř nový adresář ve VS Code.
2. Ulož níže uvedené soubory do tohoto adresáře:
   - index.html
   - styles.css
   - script.js
   - README.md
...
- Přepínání motivu: ukládá se do localStorage, můžeš to rozšířit.

Pokud chceš, mohu:
- Přidat stránku "Portfolio" s detailními projekty,
- Připojit reálné odesílání formuláře (přes Formspree nebo jednoduché serverless řešení),
- Upravit design podle tvých barev/loga.
